...
func NewDBSynchronizer() DBSynchronizer {
	...
	return DBSynchronizer{
		name:         "evote.ref_calon_gubernur",
		dependsOn:    []string{},
		recordReader: r,
		sqlDelete:    `DELETE FROM "evote"."ref_calon_gubernur"`,
		sqlDrop:      `DROP TABLE IF EXISTS "evote"."ref_calon_gubernur"`,
		sqlCreate: `
            CREATE TABLE "evote"."ref_calon_gubernur" (
                "calon" text NOT NULL,
                PRIMARY KEY (calon)
            )
        `,
