...
func NewDBSynchronizer() DBSynchronizer {
	...
	return DBSynchronizer{
		name:         "evote.ref_calon_himatro",
		dependsOn:    []string{},
		recordReader: r,
		sqlDelete:    `DELETE FROM "evote"."ref_calon_himatro"`,
		sqlDrop:      `DROP TABLE IF EXISTS "evote"."ref_calon_himatro"`,
		sqlCreate: `
            CREATE TABLE "evote"."ref_calon_himatro" (
                "calon" text NOT NULL,
                PRIMARY KEY (calon)
            )
        `,
